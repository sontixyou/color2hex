...
#     # private
#     def self.input_to_array(red, green, blue)
#       array = []
...
#     def self.generate_hex_array(hex_number_array)
#       hexes = []
